...
const InternshipSection = () => {
  return (
    <section className="py-16 px-6 max-w-7xl mx-auto">
      <h2 className="text-3xl font-bold text-black text-center mb-10">Available Internships</h2>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {internshipsData.map((intern) => (
          <div key={intern.id} className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition border border-black">
            <h3 className="text-xl font-semibold text-black mb-2">{intern.title}</h3>
            ...
            <Link
              ...
              className="inline-block bg-black text-white py-2 px-4 rounded hover:bg-gray-600 transition"
            >
              Apply Now
            </Link>
          </div>
