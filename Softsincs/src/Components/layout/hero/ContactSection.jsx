...
const googleFormLink =
  "https://docs.google.com/forms/d/e/1FAIpQLSeCTy_otfq3-1HMWEG075-vM2cThXd3rr03M4aRJmI3-k8ChA/viewform?hl=en";
  ...
  return (
    <section className="py-12 bg-gray-50 dark:bg-gray-100 dark:text-gray-900">
      <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
        ...
        <div className="py-6 md:py-0 md:px-6">
          ...
          <div className="space-y-4 text-gray-700">
            <p className="flex items-center">
              ...
              <span>Ghirnatah, Dammam,Saudia Arabia</span>
            </p>
            <p className="flex items-center">
              <svg className="w-5 h-5 mr-2 text-violet-600" fill="currentColor" viewBox="0 0 20 20">
        ...
        {/* Button and Form */}
        <div className="py-6 md:py-0 md:px-6 flex flex-col items-center">
          <button
            onClick={() => setShowForm((prev) => !prev)}
            className="w-full max-w-md py-3 mb-6 bg-[#2e35d7] text-white font-semibold rounded-lg hover:bg-white hover:text-[#2e35d7] hover:border-2 border-[#2e35d7] transition duration-300"
          >
            {showForm ? "Hide Contact Form" : "Fill Out Our Contact Form"}
          </button>

          {showForm && (
            <div className="w-full max-w-4xl aspect-[4/3] rounded-md overflow-hidden border border-gray-300 shadow-lg">
              <iframe
                src={googleFormLink}
